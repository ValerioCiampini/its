...
class Auto(Veicolo):
    ...
    def descrivi_veicolo(self):
        return f"Marca: {self.marca}, Modello: {self.modello}, Anno: {self.anno}, Numero porte: {self.numero_porte}"
...
print(veicolo.descrivi_veicolo())  # Test del metodo descrivi_veicolo per Veicolo
